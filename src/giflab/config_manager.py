...
try:
    from watchdog.events import FileModifiedEvent, FileSystemEventHandler  # type: ignore[import-not-found]
...
class ConfigValidator:
    ...
    def __init__(self) -> None:
        self.validators: dict[str, list[Callable[..., Any]]] = {}
        self.relationship_validators: list[Callable[..., Any]] = []
    ...
    def _register_default_validators(self) -> None:
        ...
        self.add_validator(
            "VALIDATION_CACHE.memory_limit_mb", self._validate_positive_int
        )
        self.add_validator(
            "VALIDATION_CACHE.disk_limit_mb", self._validate_positive_int
        )
    ...
    def _validate_cache_memory_relationship(self, config: dict[str, Any]) -> str | None:
        ...
        total_memory = (
            frame_cache.get("memory_limit_mb", 0)
    ...
    def add_validator(
        self, path: str, validator: Callable[..., Any], error_msg: str | None = None
    ) -> None:
    ...
    def add_relationship_validator(self, validator: Callable[..., Any]) -> None:
...
class ConfigManager:
    ...
    def _apply_environment_overrides(self) -> None:
        ...
        for env_key, env_value in os.environ.items():
            ...
            # Apply the override
            self._set_value_by_parts(self._config, parts, parsed_value)

            logger.info(f"Applied environment override: {config_path} = {parsed_value}")

    def _set_value_by_parts(self, config: dict[str, Any], parts: list[str], value: Any) -> None:
    ...
    def _setup_signal_handler(self) -> None:
        ...
        def handle_reload_signal(signum: Any, frame: Any) -> None:
    ...
    def export_config(self, include_defaults: bool = True) -> dict[str, Any]:
        ...
        with self._config_lock:
            ...
            return {
                ...
                "profile": self._metadata.active_profile.value
                if self._metadata.active_profile
                else None,
            }
    ...
    def import_config(self, config_data: dict[str, Any], validate: bool = True) -> None:
        ...
        with self._config_lock:
            ...
            try:
                ...
                imported = config_data.get("config", {})
                self._config = imported if isinstance(imported, dict) else {}
                ...
                if validate:
                    ...
                    if errors:
                        raise ConfigValidationError(
                            f"Import validation failed: {errors}"
                        )
